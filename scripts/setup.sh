...
echo -e "1. Run ${YELLOW}./scripts/dev.sh${NC} to start the development servers"
echo -e "2. Open ${YELLOW}http://localhost:3000${NC} in your browser"
echo -e ""
echo -e "${GREEN}Development API Keys:${NC}"
echo -e "  Admin:  ${YELLOW}dev-admin-key-CHANGE-IN-PRODUCTION${NC}"
echo -e "  Editor: ${YELLOW}dev-editor-key-CHANGE-IN-PRODUCTION${NC}"
echo -e "  Viewer: ${YELLOW}dev-viewer-key-CHANGE-IN-PRODUCTION${NC}"
echo -e ""
echo -e "${GREEN}Useful commands:${NC}"
echo -e "  ${YELLOW}./scripts/dev.sh${NC}      - Start all dev servers"
echo -e "  ${YELLOW}./scripts/reset-db.sh${NC} - Reset database to initial state"
echo -e "  ${YELLOW}docker-compose logs -f${NC} - View MongoDB logs"
echo -e ""
echo -e "${RED}WARNING:${NC} The API keys above are for development only!"
echo -e "Never use them in production!"
echo -e ""
