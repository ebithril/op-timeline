...
object TestData {
    ...
    fun createEra(
        ...
        description: String? = null,
        startDateType: DateType = DateType.Exact,
        startDate: ExactDate? = ExactDate(year = 1500, month = 1, day = 1),
        startRelativeEraId: ObjectId? = null,
        startRelativeEventId: ObjectId? = null,
        startRelativeOffset: Int? = null,
        startRelativeTimeUnit: TimeUnit? = null,
        startRelativeDirection: RelativeDirection? = null,
        startApproximateDescription: String? = null,
        startCalculatedAbsoluteDate: Double? = null,
        startCalculatedExactDate: ExactDate? = null,
        startDisplayYear: Int? = startDate?.year,
        endDateType: DateType = DateType.Exact,
        endDate: ExactDate? = ExactDate(year = 1520, month = 12, day = 31),
        endRelativeEraId: ObjectId? = null,
        endRelativeEventId: ObjectId? = null,
        endRelativeOffset: Int? = null,
        endRelativeTimeUnit: TimeUnit? = null,
        endRelativeDirection: RelativeDirection? = null,
        endApproximateDescription: String? = null,
        endCalculatedAbsoluteDate: Double? = null,
        endCalculatedExactDate: ExactDate? = null,
        endDisplayYear: Int? = endDate?.year,
        createdAt: Long = System.currentTimeMillis(),
        createdBy: String? = "testuser",
        updatedAt: Long = System.currentTimeMillis(),
        ...
        startDate = startDate,
        startRelativeEraId = startRelativeEraId,
        startRelativeEventId = startRelativeEventId,
        startRelativeOffset = startRelativeOffset,
        startRelativeTimeUnit = startRelativeTimeUnit,
        startRelativeDirection = startRelativeDirection,
        startApproximateDescription = startApproximateDescription,
        startCalculatedAbsoluteDate = startCalculatedAbsoluteDate,
        startCalculatedExactDate = startCalculatedExactDate,
        startDisplayYear = startDisplayYear,
        endDateType = endDateType,
        endDate = endDate,
        endRelativeEraId = endRelativeEraId,
        endRelativeEventId = endRelativeEventId,
        endRelativeOffset = endRelativeOffset,
        endRelativeTimeUnit = endRelativeTimeUnit,
        endRelativeDirection = endRelativeDirection,
        endApproximateDescription = endApproximateDescription,
        endCalculatedAbsoluteDate = endCalculatedAbsoluteDate,
